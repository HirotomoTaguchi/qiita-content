...
Teamsに関するセキュリティ対策は以下のような情報を見ると非常に参考になるかと思います。

https://www.microsoft.com/en-us/security/blog/2025/10/07/disrupting-threats-targeting-microsoft-teams/

とはいえ、今回はCEO 詐欺における Microsoft Teams の悪用を中心に取り上げましたが、「外部アクセスをブロックすればいい」「ゲストを禁止すればいい」といった単発の設定変更で終わらせてしまうのは健全ではありません。この機能はもちろんですが、Teamsだけではなく、Microsoft 365 はもちろんですが、自社が利用しているツール全体のセキュリティをデザインすることが大事だと思います。

冒頭にも言及しましたが、他のツールでも全然起こりえますし、正規ツールの悪用は攻撃者の有効な手段であり続けています。

![](https://github.com/user-attachments/assets/3a893e2e-6961-4488-9d02-d3e13e423f81)
